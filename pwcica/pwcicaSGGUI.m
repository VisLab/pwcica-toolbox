% pwcicaSGGUI -- Calls GUI for pwcica within EEGLAB
%
% Usage: options = pwcicaSGGUI(EEG)
...
thegeometry = { [.5 .5 .5] [.5 .5 .5] [1 .5] [1 .5] [1 .5] [1 .5] [.2 .15 1.15] [.2 .15 1.15] [.2 .15 1.15] [1 .5] };
theuilist = { ...
    {'style', 'text', 'string' , '_____________'},...
    {'style', 'text', 'FontWeight', 'bold', 'string', 'PWC-ICA w/'},...
    {'style', 'text', 'string' , '_____________'},...
    {'style', 'text', 'string' , '_____________'},...
    {'style', 'text', 'FontWeight', 'bold', 'string', 'Savitzky-Golay'},...
    {'style', 'text', 'string' , '_____________'},...
